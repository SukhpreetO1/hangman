...
def hangman_game(word):
    ...
    while True:
        ...
        print("Try to guess the word in less than 7 chances.....   \n ")
...
if __name__ == "__main__":
    ...
    # Types of categories
    topics = {1: "Easy Level", 2: "Medium Level", 3: "Hard Level"}

    # Words in each category
    dataset = {
        "Easy Level": ["games", "adventure", "flower", "school", "laptop", "computer", "kitchen", "books", "blood", "minute", "colour", "respect"],
        "Medium Level": ["rainbow", "flipping", "digital", "science", "bollywood", "project", "career", "classroom", "harmony", "mountain", "ornament"],
        "Hard Level": ["mathematics", "application", "advertisement", "government", "rhythm", "substance", "crackdown", "discrepancy", "panacea"]
        }
